...
public class Grant
{
    ...
    /**
     * Get the percentage of the reimbursement total that this grant is responsible for as a
     * fraction from 0->1
     * 
     * @return - the percentage this grant is responsible for as a fraction
     */
    public Double getGrantPercentageFraction()
    {
        return grantPercentage / 100.0;
    }
