...
public class TransportationExpense implements ExpenseWithCurrencyIface
{
    ...
    /**
     * Is this transportation expense for a rental car?
     * 
     * @return True if this is a rental car, otherwise false.
     */
    public boolean isRentalCar()
    {
        boolean rental = (transportationType == TransportationTypeEnum.CAR);
        rental &= (transportationRental.compareToIgnoreCase(TRAPConstants.STR_YES) == 0);
        return rental;
    }
